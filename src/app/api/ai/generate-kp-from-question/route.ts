...
export async function POST(request: Request) {
  ...
  const prompt = `你是一位经验丰富的国际学校化学教师。请根据以下错题的题干和解析，生成一份全面系统的知识点总结。
...
1. 用纯文本格式（不用任何HTML标签），包含以下部分：
   - **核心概念**：这道题考察的化学概念是什么
   - **关键原理**：详细阐述背后的化学原理和规律
   - **相关公式/反应**：写出相关的化学方程式或计算公式，如 4Fe + 3O2 + 2H2O → 2Fe2O3·H2O
   - **易错辨析**：学生容易混淆的概念或常见错误
   - **知识拓展**：相关的延伸知识点，如该概念在生活/工业中的应用
2. 围绕题目主题全面展开，不仅限于题目本身考到的点。例如题目考铁生锈的条件，还要补充生锈的化学方程式、铁锈的成分与性质、防锈措施及原理等
